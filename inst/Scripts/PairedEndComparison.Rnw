...
{
    lane1 <- growSeqs(lane1)
    lane2 <- growSeqs(lane2)
...
<<>>=
## fibro
plotLanePair(lane1 = pairedReads[["1"]],
             lane2 = myodFibro[["2"]],
...
<<>>=
## myotubes
plotLanePair(lane1 = pairedReads[["2"]],
             lane2 = myodMyo[["2"]],
             chrom.lens = mouse.chromlens,
             min.depth = 8)
...
plotLanePair(lane1 = myodFibro[["2"]],
             lane2 = myodFibro[["4"]],
             chrom.lens = mouse.chromlens,
             min.depth = 8)
...
plotLanePair(lane1 = myodFibro[["3"]],
             lane2 = myodFibro[["2"]],
             chrom.lens = mouse.chromlens,
             min.depth = 8)
